      ...
      >
        <div className="flex justify-between items-center w-full max-w-7xl mx-auto px-margin-mobile md:px-margin-desktop gap-3">
          <div className="flex items-center gap-6 xl:gap-8 min-w-0">
            ...
            {/* Full desktop nav from xl (1280+) — lg/1024 is too tight with Partners added */}
          ...
          <div className="flex items-center gap-2 shrink-0">
            <Link
              href="/contact"
              className="xl:hidden px-3 py-1.5 text-primary border border-primary/30 rounded-lg font-label-sm text-xs hover:bg-primary hover:text-on-primary transition-all active:scale-95 whitespace-nowrap"
            >
              {t.nav.getInTouch}
            </Link>
            <MobileNavMenu />
            <Link
              href="/contact"
              className="hidden xl:inline-flex px-6 py-2 bg-primary text-on-primary rounded-lg font-label-sm text-label-sm hover:brightness-110 shadow-sm transition-all active:scale-95"
            >
              {t.nav.getInTouch}
            </Link>
          </div>
